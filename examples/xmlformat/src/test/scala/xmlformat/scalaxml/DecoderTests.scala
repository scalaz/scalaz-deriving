  ...
  "XNode Decoder" - {
    ...
    "should fail on unparsed input" in {
      Decoder[XNode]
        ...
        .leftValue shouldBe "encountered unparsed xml: foo"
    }
  ...
  "XML Decoder" - {
    ...
    "should support Traversables" in {
      ...
      "<value>1</value><value>2</value><value>3</value>"
        .as[List[Int]] shouldBe List(1, 2, 3)
      "<value>1</value><value>2</value><value>3</value>"
        .as[Seq[Int]] shouldBe Seq(1, 2, 3)
      "<value>1</value><value>2</value><value>3</value>"
        .as[Set[Int]] shouldBe Set(1, 2, 3)
    ...
    "should support generic products" in {
      ...
      "".failsAs[Foo] shouldBe "when decoding xmlformat.examples.Foo: missing tag s"

      "".failsAs[MultiField] shouldBe "when decoding xmlformat.examples.MultiField: missing tag a"
    ...
    "should support generic coproducts" in {
      ...
      "<meh/>"
        .failsAs[SimpleTrait] shouldBe "when decoding xmlformat.examples.SimpleTrait: no valid typehint in 'XTag(XAtom(meh),[],XChildren([]))'"
    ...
    "should decode XmlAttribute fields" in {
      ...
      """<MultiField b="goodbye"><a>hello</a></MultiField>"""
        .as[MultiFieldParent] shouldBe MultiField("hello", Tag("goodbye"))
    }
