...
// backported from scalaz 7.3: by-name params
trait LazyDivide[F[_]] extends Contravariant[F] {
...
trait LazyDivisible[F[_]] extends LazyDivide[F] {
  def conquer[A]: F[A]
