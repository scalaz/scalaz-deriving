...
class TestTreeHelper(val tb: Toolbelt with TypeListAST) {
  ...
  def cons[T](node: Fix[NodeF] = nnil)(implicit
    evT: WeakTypeTag[T]
  ): Fix[NodeF] = Fix[NodeF](ConsF(evT.tpe, node))
  def consk[T[_]](node: Fix[NodeF] = nnil)(implicit
    evT: WeakTypeTag[T[?]]
  ): Fix[NodeF] = Fix[NodeF](ConsF(evT.tpe.typeConstructor, node))
  ...
  def remove[T](node: Fix[NodeF] = nnil)(implicit
    evT: WeakTypeTag[T]
  ): Fix[NodeF] = Fix[NodeF](RemoveF(evT.tpe, node))
  def removek[T[_]](node: Fix[NodeF] = nnil)(implicit
    evT: WeakTypeTag[T[?]]
  ): Fix[NodeF] = Fix[NodeF](RemoveF(evT.tpe.typeConstructor, node))
}
