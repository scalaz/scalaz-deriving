...
package adt {
  ...
  final case object Baz extends Foo {
    ...
    implicit val equal: Equal[Baz.type] =
      Derivez[Equal].xderiving0(Baz)
    implicit val default: Default[Baz.type] =
      Derivez[Default].xderiving0(Baz)
  }
  object Bar {
    implicit val equal: Equal[Bar] =
      Derivez[Equal].xderiving1((s: String) => Bar(s), _.s)
    implicit val default: Default[Bar] =
      Derivez[Default].xderiving1((s: String) => Bar(s), _.s)
  }
  object Faz {
  ...
  object Foo {
    ...
    implicit val equal: Equal[Foo] =
      Derivez[Equal].xcoderiving3(to, from)
    implicit val default: Default[Foo] =
      Derivez[Default].xcoderiving3(to, from)
  }
}
